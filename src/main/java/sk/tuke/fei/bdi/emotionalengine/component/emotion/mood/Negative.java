...
public class Negative extends Mood {
    ...
    public void calculateIntensity(Engine engine) {
        ...
        addValidEmotionIntensityValues(engine, R.GOAL, R.DISPLEASED, values);
        addValidEmotionIntensityValues(engine, R.PLAN, R.DISAPPROVING, values);
        addValidEmotionIntensityValues(engine, R.BELIEF, R.DISLIKING, values);
